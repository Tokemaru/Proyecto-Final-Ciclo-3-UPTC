...
SECRET_KEY = '*@89f5^s+$&-uzq_m_3!qu84=e7g8+cfexq)m%8_g8=@2xot94'
...
TEMPLATES = [
    {
        ...
        #en dirs agregamos la ruta de la carpeta donde esta el html importante cambiarla cuando se suba a github
